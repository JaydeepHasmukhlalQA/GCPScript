resource "google_compute_instance" "poolui_compute" {
  ...
  connection {
    ...
    host        = "${google_compute_instance.poolui_compute.network_interface.0.access_config.0.nat_ip}"
